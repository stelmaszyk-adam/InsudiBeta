...
public class User3Fragment extends Fragment {
    ...
    private void loadData()
    {
        ...
        int i=0;
        for(String data : staticData.statyczneDaneUserThird){
    ...
    {
        String [] table = {"","","","",""};
        table = getResources().getStringArray(R.array.text_user_third);
    ...
    public void OnClickGoTo()
    {
        ...
        staticData.statyczneDaneUpload(getContext());
    ...
    {
        User2Fragment calculator = new User2Fragment();
    ...
    private boolean checkIfIsEmpty()
    {
        ...
        for(int i =0; i<staticData.statyczneDaneUserThird.size(); i++){
            staticData.statyczneDaneUserThird.set(i, table_text[i]);
        }
        return false;
    }
